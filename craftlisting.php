...
<body id="createlisting">
    ...
    <form class="create_listing_form" method="POST" action="insertcraftlisting_backend.php" enctype="multipart/form-data">
        ...
        <div class="input_fields">
            ...
            <div class="input_price_container">
                <input type="number" placeholder="0" name="list_price" id="list_price" class="inputForm" required>
