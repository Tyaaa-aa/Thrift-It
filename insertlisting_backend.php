...
if (in_array($fileActualExt, $allowed)) {
    ...
    $stmt = $conn->prepare("INSERT into sp_listings (list_title, list_category, list_type, list_image, list_desc, list_dealMethod, iUserid, list_points,list_carbon) values (?,?,?,?,?,?,?,?,?)");
