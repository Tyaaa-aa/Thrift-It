...
$stmt = $conn->prepare("INSERT into sp_chats (chat_buyerid, chat_sellerid,chat_listid, chat_buyermessage) values (?,?,?,?)");
...
$stmt = $conn->prepare("INSERT into sp_chats (chat_buyerid, chat_sellerid,chat_listid, chat_sellermessage) values (?,?,?,?)");
